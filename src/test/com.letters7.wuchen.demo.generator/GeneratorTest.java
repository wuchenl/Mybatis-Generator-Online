...
public class GeneratorTest {
    ...
    public void testSqlConnect() {
        ...
        databaseConfig.setDbType("MySQL8").setEncoding(GeneratorConst.ENCODE_UTF8).setHost("").setPort("")
                .setName("test").setUsername("").setPassword("").setSchema("");
    ...
    public void testSqlGetTables() throws SQLException {
        DatabaseConfig databaseConfig = DatabaseConfig.builder().build();
        databaseConfig.setDbType("MySQL_8").setEncoding(GeneratorConst.ENCODE_UTF8).setHost("").setPort("")
                .setName("test").setUsername("").setPassword("!").setSchema("");
